...
enum BenchmarkReferences {
    ...
    static let hardwareTiers: [HardwareTier] = [
        HardwareTier(name: "Intel Legacy", subtitle: "Core i5 / i7", tossyMark: 4_500, isReference: false),
        HardwareTier(name: "Apple M1", subtitle: "8-Core Baseline", tossyMark: 12_000, isReference: false),
        HardwareTier(name: "Apple M2 / M3", subtitle: "Standard Mac", tossyMark: 20_000, isReference: false),
        HardwareTier(name: "Apple M4 Air", subtitle: "M4 10-Core Reference", tossyMark: 32_000, isReference: true),
        HardwareTier(name: "Apple M4 Pro", subtitle: "14-Core Workstation", tossyMark: 48_000, isReference: false),
        HardwareTier(name: "Apple M4 Max / Ultra", subtitle: "Extreme Highline", tossyMark: 75_000, isReference: false)
    ]

    /// Calibrated baseline throughput values yielding exactly 32,000 points on Apple M4 Air hardware.
